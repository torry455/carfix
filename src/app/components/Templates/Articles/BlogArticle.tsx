...
export const BlogArticle: React.FC<BlogArticleProps> = ({
  ...
  return (
    <article className="max-w-5xl mx-auto p-6 sm:p-8 md:p-10 bg-black/70 shadow-lg rounded-3xl my-10 transition-all duration-300 hover:shadow-2xl hover:scale-[1.01]">
      {/* Заголовок */}
      <h2 className="uppercase text-center text-l sm:text-l md:text-xl font-['Manrope-ExtraBold'] text-[var(--color-brand-gold)] mb-6 ">
        {title}
      </h2>
      ...
      {/* Контент Grid */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 text-[var(--text-gray)] leading-relaxed text-base sm:text-lg font-['Manrope-Regular']">
      ...
      {highlights && highlights.length > 0 && (
        <div className="mt-8 p-6 bg-[#fffaed] dark:bg-[#1f1f23] rounded-xl border-l-4 border-[#be7d00] md:col-span-12">
          <h4 className="font-['Manrope-Bold'] text-[#be7d00] text-lg mb-3">
            Важливі моменти:
          </h4>
