    ...
    <header className="bg-[#fff]/3 font-[Manrope-Bold] tracking-widest uppercase backdrop-blur-xl rounded-[50px] text-[#E5E4E4] py-4 px-6 sm:px-10 w-full z-50 sticky top-5 max-w-[1500px] m-auto">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-8 text-lg font-medium">
          ...
          <button className="bg-[#BE7D00] text-[#17181C] font-[Manrope-ExtraBold] tracking-widest uppercase px-6 py-2 rounded-lg shadow-md hover:bg-[#a36600] transition-colors duration-300 mr-4">
            Записатись
          </button>
          {/* <Link
            href="/login"
            className="text-[#BE7D00] font-semibold hover:underline"
          >
            Увійти
          </Link> */}
        </nav>
