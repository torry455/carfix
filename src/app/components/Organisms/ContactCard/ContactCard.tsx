export const ContactCard = () => {
  return (
          <div className="flex-1 flex flex-col lg:flex-row gap-8 bg-black/70 rounded-lg p-8 shadow-lg">
        ...
        <div className="w-full sm:w-[48%] flex flex-col gap-4">
          ...
          <p className="mb-2 font-[Manrope-ExtraBold] text-[#BFC0C0]">
            Графік роботи:
          </p>
          <ul className="mb-4 space-y-2 text-[#BFC0C0]">
            <li>
              ПН–ПТ: 
            ...
            <li>
              СБ–НД: 
              <span className="font-[Manrope-Bold]">вихідні</span>
            </li>
          </ul>
          ...
          <ul className="mb-4 space-y-2">
            <li>
              <a
                ...
                className="hover:text-[var(--color-brand-gold)] transition-colors font-[Manrope-Bold]"
              >
                +38 067 250 09 25
              </a>
            </li>
          ...
          <ul className="mb-0 space-y-1 text-[#BFC0C0] font-[Manrope-Bold]">
        ...
        <div className="w-full sm:w-[48%] flex flex-col gap-4">
          ...
          <div className="rounded-lg overflow-hidden shadow-lg">
            ...
            <a
              ...
              className="text-xs block mt-2 text-center uppercase bg-[#BE7D00] text-[#17181C] font-semibold px-1 py-2 rounded-full shadow-md hover:bg-[#a36600] transition-colors duration-300"
            >
