  ...
  return (
    ...
    <div className="relative w-full h-72 sm:h-96 rounded-2xl overflow-hidden shadow-lg">
      ...
      />
        ...
        {/* Текстовий блок */}
        <div>
          <h2 className="text-3xl sm:text-4xl font-bold text-[#BE7D00] mb-6">
            Навчання
          </h2>

          <p className="text-[#CFCFCF] mb-6 text-lg leading-relaxed">
            Ми працюємо на результат. Наш підхід — це баланс практики та теорії, який допоможе вам стати професіоналом у сфері PDR.
          </p>
          ...
          <p className="text-[#BFC0C0] mb-8">
            Від вас потрібні лише мотивація, терпіння та бажання навчитись. 
            Не відкладайте на завтра те, що можна почати сьогодні. Отримайте нові знання та вміння, які дозволять вам заробляти в сфері PDR на рівні ІТ-спеціалістів.
          </p>

          <a
            href="#contact"
            className="inline-block bg-[#BE7D00] text-[#17181C] px-8 py-3 rounded-full font-semibold text-lg shadow-md hover:bg-[#d28f0a] transition-colors"
          >
            Запис на навчання
          </a>
        </div>
